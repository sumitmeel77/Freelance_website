            ...
            <div className="main_body">
                <div className="main box_center">
                    <div className="main_box">
                        <ul className="box_menu_process">
                            <li className="box-menu-element-process " style={{ display: "block", top: "10px", left: "10px", opacity: "1" }}>
                                <a href="/#/process">
                        ...
                        <div className="menu_window" style={{ display: "block ", overflow: "hidden", padding: "0px", width: " 550px " }}>
                            <div className="menu_page_process" style={{ opacity: "1" }}>
                                <h1>From fantasy to reality.</h1>
                            </div>
