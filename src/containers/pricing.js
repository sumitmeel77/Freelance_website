            ...
            <div className="main_body">
                <div className="main box_center">
                    <div className="main_box">
                        <ul className="box_menu_pricing">
                            <li className="box-menu-element-pricing " style={{ display: "block", top: "10px", left: "10px", opacity: "1" }}>
                                <a href="/#/pricing">
                        ...
                        <div className="menu_window" style={{ display: "block ", overflow: "hidden", padding: "0px", width: " 550px " }}>
                            <div className="menu_page_pricing" style={{ opacity: "1" }}>
                                <h1>Setting up a website for your company does not cost as much as may expect.</h1>
                            </div>
